...
cd ${TOPDIR}/include/ && rm -rf `ls | grep "asm-" | egrep -v "arm I generic"`
#cd ${TOPDIR}/include/asm-arm/ && -rf `ls | grep "arch-" | grep -v "s3c24x0"`
cd ${TOPDIR}/include/configs/ && rm -rf `ls | grep -v "smdk2410.h"`
cd ${TOPDIR} && rm -rf `ls | grep "lib_" | egrep -v "armJgeneric"`
